...
### **Warning!** This project is in development stage and is not yet ready for production usage. There exists hardcode, which may not be executable on your machine. (Sooner will be removed)
...
### Notes:
- Reworked argument parsing system and added support of multiple arguments. Support is not full, and later will be added coordination and overriding between different arguments.
```
dir /path1 /path2 -arg1 -arg2
```
...
|  /l       | Displays unsorted directory names and file names, using lowercase. (partial)   |
